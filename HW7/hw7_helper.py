...
"""
Internal math within one round of SHA-256. You can ignore the next ~100 lines for the homework.
"""
...
"""
The remaining code builds the full compression function, appends a specific padding scheme that is
consistent with Bellare's rules, and runs Merkle-Damgard to build SHA-256.

You will need some of these methods in the homework. The test() function may help you to understand the code.
"""
...
def test():
    ...
    n = pad_message(b'abc')[0]
    old_hash = 'ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad'

    digest = compression_function(old_hash, pad_message(b'1' * 10, 74)[0])

    assert hashlib.sha256(n + b'1' * 10).hexdigest() == digest
